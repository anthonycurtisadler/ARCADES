...
simple_commands =  {'dumpprojects':JSON_COM,
                    ...
                    'reader':RESIZE_COM,
                    'indexer':RESIZE_COM,
                    'clearsuppresskeys':'self.keypurger.temporary=set()',
                    'addsuppresskeys':RESIZE_COM,
                    'deletesuppresskeys':RESIZE_COM,
                    'showsuppresskeys':'display.noteprint(("KEYWORDS TO SUPPRESS",", ".join(self.keypurger.permanent)))',     
