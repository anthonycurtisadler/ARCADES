...
class Alerts:
    def __init__(self):
          ...
          self.APPEARS_END = ' times. Frequence='
          self.FAILED_CONF_LOAD = 'Failed to load configuration file'
          self.CREATING_NEW_CONF = '/C/Creating New configuration file'
          self.NEW_PICKLE = 'New pickle file'
          self.ENTER_DOCUMENTATION = 'Enter documentation '\
                                     +'to load introduction'
          ...
          self.TOO_MANY_INDEXES = 'TOO many indexes!'
          self.IS_CLOSING = ' is closing!'
          self.OPENING = ' will be opened as '
          self.ALREADY_OPEN = ' is already open!'
          self.DELETE_FROM_TO = 'Delete from / to'
          self.EXLUDE_ALL_CAPS = 'Exclude all-cap keywords?  '
          self.EXCLUDE_CAPITALIZED = 'Exclude capitalized keywords? '
          self.NOT_YET_CLUSTERED = 'NOT YET CLUSTERED'
          self.FLIP_CHANGED = 'FLIPBOOK changed to'

          self.SAVING = 'Saving '
          self.WORD_DICT_CONSTITUTED =  'WORD DICTIONARY CONSTITUTED'
          self.NOT_REGULAR = 'NOT REGULAR'
          self.ADDED = 'Added'
          self.MOVING_FROM = 'MOVING from '
          ...
          self.KEYS = 'Keys?'
          self.FIELDS = '   Fields?'
          self.LOADING_FILE = 'LOADING FILE'
...
class Labels:
     def __init__(self):
          ...
          self.ALWAYS_NEXT = 'Always Next'
          self.ALWAYS_CHILD = 'Always Child'
          ...
          self.KEYS = '/C/KEYS'
          self.ITERATOR_SHOW = 'Show indexes with iterator reset'

          self.CAPKEYS = '/C/CAPKEYS'
          self.PROPER_NAMES = '/C/Proper Names'
          self.OTHER_KEYS = '/C/Other Keys'
          self.SHOW_TOP = 'Show the top note with children'
          self.TAGS = '/C/TAGS'
          self.PURGEKEYS = '/C/Purgekeys settings'
          self.FIELD = '/C/FIELDS'
          self.FILE_ERROR = 'File Error!'
          self.CONSTITUTING_KEY_FREQ = '/C/Consistuting key'\
                                       +' frequency dictionary!'

          self.WELCOME_HEAD = '/C/WELCOME'
          self.WELCOME_BODY = 'Welcome to NOTESCRIPTION!'
          ...
          self.AUTOMULTI ='/C/Auto Multi Display'
          ...
          self.ITERATOR_SHOW = 'Show indexes with iterator reset'
          self.NONE = 'NONE'
          self.COMMAND_EQ = 'COMMAND = '
          self.CONCORDANCE = 'CONCORDANCE'
          self.TO_UNDO = '/C/TO UNDO'
          self.DELETED = '/C/Deleted notes'
          self.CONFIG_SAVED = '/C/Configuration saved'
          self.VARIABLES = 'Variables'
          self.KEYS_BEFORE = 'Keys Before'
          self.KEYS_AFTER = 'Keys After'
          self.CARRY_OVER_KEYS = 'Carry Over Keys'
          self.CARRY_ALL = 'Carry Over from All Parents'
          self.SETTINGS = '/C/SETTINGS'
          self.RETURN_QUIT_ON = 'RETURNQUIT'
